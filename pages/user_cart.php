        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <a class="btn btn-primary btn-round" href="user_index.php"><i class="now-ui-icons shopping_basket"></i> &nbsp Order more items</a>
                      <hr color="orange"> 
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <select class="btn btn-warning btn-round dropdown-toggle" size="1" name="city">
                        <!--Villages Starts With (A)-->
                      <option value="Achattipura">Achattipura</option>
                      <option value="Aldur">Aldur</option>
                      <option value="Alur">Alur</option>
                      <option value="Amachavadi">Amachavadi</option>
                      <option value="Ammanapura">Ammanapura</option>
                      <option value="Ankanasettypura">Ankanasettypura</option>
                      <option value="Arakalavadi">Arakalavadi</option>
                      <option value="Aralikatte">Aralikatte</option>
                      <option value="Attagulipura">Attagulipura</option>
                      <option value="Ayyanapura">Ayyanapura</option>

                      <!--Villages Starts With (B)-->
                      <option value="Badagalapura">Badagalapura</option>
                      <option value="Badanaguppe">Badanaguppe</option>
                      <option value="Bagali">Bagali</option>
                      <option value="Banahalli">Banahalli</option>
                      <option value="Bandigere">Bandigere</option>
                      <option value="Bandigowdanahalli">Bandigowdanahalli</option>
                      <option value="Basavanapura">Basavanapura</option>
                      <option value="Basavapura">Basavapura</option>
                      <option value="Basavatti">Basavatti</option>
                      <option value="Basthipura"> Basthipura</option>
                      <option value="Bedaguli">Bedaguli</option>
                      <option value="Bagali">Bagali</option>
                      <option value="Badagalapura">Badagalapura</option>
                      <option value="Badanaguppe">Badanaguppe</option>
                      <option value="Bagali">Bagali</option>
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <!--<div class="copyright">
                    ...
                    </script>, Designed and Developed by Active Marts
                </div>-->
            </div>
        </footer>
    </div>

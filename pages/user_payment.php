...
$query = "INSERT INTO orderr (user_id, track_num, firstname, middlename, lastname, email, contact, shipping_add, order_date, status, totalprice, tax) 
...
?>
        ...
        <h3>Delivery process time, minimum of thirty(30) Minutes and maximum of Fourty(40) Minutes.</h3><br>
        <h5>Drivers Hotel</h5>
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Developed by <a href="http://info.activemarts.com">Active Marts</a>
                </div>
            </div>
        </footer>
    </div>

...
<?php
                                      ...
                                      $query = "SELECT * FROM orderr ORDER BY order_date ASC";
...
<h3>Change Status</h3>
<form action="test121.php" method="post">
	<input type="text" name="tracking_number" Placeholder="Enter Tracking Number" class="form-control">
	<select name="status121" class="btn btn-primary btn-round">
		<option>Pending</option>
		<option>Delivered</option>
	</select>
	<input type="submit" value="Change Status" class="btn btn-primary btn-round">
</form>

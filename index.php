            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/ironman.jpg');">
                ...
                <div class="container">
                    <div class="content-center brand">
                        ...
                        <br><br>
                        <h3>Driver's Hotel</h3>
                        <h4>Get Best Meals!</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h4 class="title">Get your money back if your order is late!</h4>
                        ...
                        <center>
                        <label><h3>Search items &nbsp</h3></label>       
                                <form method="POST" action="index_search.php" >
                                    <input type="image" title="Search" src="assets/img/search.png" alt="Search" />
                                    <input type="text" name="search" class="form-control" placeholder="Enter recipe name">
                                </form>
                        </center>
                    </div>
                    <br><hr color="orange">
...
?>   
    <div class="row-sm-3">
        ...
        <div class="caption">
          ...
          <h6 align="center"><medium class="btn btn-success btn-round">Price:&nbsp;<?php echo $res['prod_price']; ?></medium><br>
          <a class="btn btn-success btn-round" title="Click for more details!" href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a></h6>
        </div>
